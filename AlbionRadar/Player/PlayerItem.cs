...
namespace AlbionNetwork2D
{
    class PlayerItem
    {
        ...
        public static void loadItemList(String languageSelected)
        {
            dynamic jsonArray = JsonConvert.DeserializeObject(Encoding.UTF8.GetString(Properties.Resources.items));
            foreach (var item in jsonArray)
            {
                string lang = languageSelected != "EN" ? "PT-BR" : "EN-US";
                var localizedName = item["LocalizedNames"] != null ? item["LocalizedNames"][lang] : "";
